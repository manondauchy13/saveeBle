...
class BleServiceAdapter (private val bleServices:List<BleService>,
...
) : ExpandableListAdapter<BleServiceAdapter.ServiceViewHolder, BleServiceAdapter.CharacteristicViewHolder>(bleServices) {

    class ServiceViewHolder(itemView: View): ViewGroup(itemView) {
    ...
    class CharacteristicViewHolder(itemView: View): Child(itemView){
